...
-- Insert initial data from JSON
INSERT INTO public.meals (
  id, name, description, image, price, category, dietary_restrictions, 
  ...
  ('1', 'Avocado Toast', 'Fresh avocado on multigrain bread with cherry tomatoes', 'breakfast-meal.jpg', 8.99, 'breakfast', 
   '{"vegetarian"}', '{"avocado", "multigrain bread", "cherry tomatoes", "olive oil", "salt", "pepper"}', 
   320, 8.5, 35.2, 18.1, true, true, true, true, true, true, '2024-01-15T08:00:00Z', '2024-01-15T08:00:00Z'),
   
  ('2', 'Grilled Chicken Salad', 'Mixed greens with grilled chicken breast, cherry tomatoes, and balsamic dressing', 'lunch-meal.jpg', 12.99, 'lunch',
   '{"gluten-free"}', '{"mixed greens", "chicken breast", "cherry tomatoes", "cucumber", "red onion", "balsamic vinegar", "olive oil"}',
   285, 28.5, 12.3, 14.2, true, true, true, true, true, true, '2024-01-15T12:00:00Z', '2024-01-15T12:00:00Z'),
   
  ('3', 'Salmon Teriyaki', 'Grilled salmon with teriyaki glaze, steamed rice, and vegetables', 'dinner-meal.jpg', 18.99, 'dinner',
   '{"gluten-free"}', '{"salmon fillet", "teriyaki sauce", "jasmine rice", "broccoli", "carrots", "snap peas"}',
   420, 35.2, 45.8, 12.5, true, true, true, true, true, true, '2024-01-15T18:00:00Z', '2024-01-15T18:00:00Z'),
   
  ('4', 'Quinoa Buddha Bowl', 'Nutritious bowl with quinoa, roasted vegetables, and tahini dressing', 'vegetarian-meal.jpg', 14.99, 'lunch',
   '{"vegetarian", "vegan", "gluten-free"}', '{"quinoa", "sweet potato", "chickpeas", "kale", "red cabbage", "tahini", "lemon juice"}',
   380, 15.8, 52.3, 16.2, true, true, true, true, true, true, '2024-01-15T12:30:00Z', '2024-01-15T12:30:00Z');